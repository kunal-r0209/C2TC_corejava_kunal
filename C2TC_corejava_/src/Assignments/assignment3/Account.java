...
class CheckingAccount extends Account{
	...
	public CheckingAccount(String accountNumber, String accountHolder, double initalBalance) {
		super(accountNumber,accountHolder,initalBalance);
	}
	...
	public void withdraw(double amount) {
		if(amount>0 && balance-amount>=OVERDRAFT_LIMIT) {
			balance-=amount;
			System.out.println("Checking: ₹"+amount+" withdraw.");
		}else {
